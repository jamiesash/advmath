...
## Question 1: 
Is it always, sometimes, or never true that union distributes over intersection:

$$ A \cup (B \cap C) = (A \cup B) \cap (A \cup C)$$

**Answer:** It is *always* true that union distributes over intersection

Here we show that $(A \cup B) \cap A \cup C \subseteq (A \cup B) \cap (A \cup C)$
...
Now we show that $(A \cup B) \cap (A \cup C) \subseteq (A \cup B) \cap A \cup C$
...
## Question 2:
Is it always, sometimes, or never true that intersection is associative:  
...
## Question 3:
Is it always, sometimes, or never true that set difference distributes over 
intersection:  
...
## Question 4:
Is it always, sometimes, or never true that set difference is associative:  
